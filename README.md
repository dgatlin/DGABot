...
* Training and evaluation a classifier aimed at discriminating between legitimate and DGA domains.
* Deploy the model by providing an inference API as a REST service. 
